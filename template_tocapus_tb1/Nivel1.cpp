...
void Nivel1::iniciar() {
    ...
    BloqueNarrativo textoEscena1(2,"Escena 1 nivel 1",0,
        { 
        R"(En la ciudad del Cusco, durante el apogeo del Imperio Inca, los conocimientos sobre los tocapus son resguardados por los cumbicamayoc, artesanos de �lite 
        encargados de tejer no s�lo textiles, sino tambi�n informaci�n cultural. Estos no son simples s�mbolos, sino un lenguaje visual que representa linajes, 
    ...
    BloqueNarrativo textoEscena3(4, "Escena 3 nivel 1", 0,
        {
        ...
        "Cada acierto se registrar� en tu c�dice."
        });
